...
using Duende.AdminPanel.STS.Identity.Configuration;
using Duende.AdminPanel.STS.Identity.Configuration.ApplicationParts;
using Duende.AdminPanel.STS.Identity.Configuration.Constants;
using Duende.AdminPanel.STS.Identity.Configuration.Interfaces;
using Duende.AdminPanel.STS.Identity.Helpers.Localization;
using Duende.AdminPanel.STS.Identity.Services;
